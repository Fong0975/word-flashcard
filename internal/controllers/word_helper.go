...
// ====================================================================================
// WEIGHTED RANDOM SELECTION GROUP - Handle familiarity/recency-weighted word sampling
// ====================================================================================
...
func (wc *WordController) fetchWordsBucketWeighted(level string, quota int) ([]*dbModels.Word, error) {
	if quota <= 0 {
...
// ====================================================================================
// PRACTICE LOG GROUP - Handle word practice log transformation and trend aggregation
// ====================================================================================

// toWordPracticeLogEntries converts data-layer practice log rows to the API response shape.
func (wc *WordController) toWordPracticeLogEntries(logs []*dbModels.WordPracticeLog) []models.WordPracticeLogEntry {
...
func (wc *WordController) buildWordTrendPoints(logs []*dbModels.WordPracticeLog, days int, now time.Time) []models.WordTrendPoint {
