...
export const QuestionQuizResults: React.FC<QuestionQuizResultsProps> = ({
  ...
  const getPerformanceMessage = (percentage: number) => {
    ...
    if (percentage >= 80) {
      return 'Great job! Your performance is very good.';
    }
    if (percentage >= 70) {
      return 'Good work! You have a solid grasp of the concepts.';
    }
    if (percentage >= 60) {
      return 'Nice effort! Consider reviewing the questions you missed.';
    }
    ...
    <div className='mx-auto max-w-4xl pt-8'>
      ...
      <div className='mb-8 rounded-xl bg-white p-8 shadow-lg dark:bg-gray-800'>
        <div className='text-center'>
          ...
          <div
            className={`inline-flex items-center rounded-full border px-4 py-2 font-semibold md:text-lg ${getScoreBadgeColor(accuracyPercentage)}`}
          >
        ...
        {/* Statistics */}
        <div className='mt-8 grid grid-cols-3 gap-6 border-t border-gray-200 pt-8 dark:border-gray-700'>
          <div className='text-center'>
      ...
      <div className='flex justify-center space-x-4'>
        <button
          ...
          className='flex w-full items-center justify-center space-x-2 rounded-lg bg-blue-500 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'
        >
          <svg
            className='h-4 w-4'
            fill='none'
        ...
        <button
          ...
          className='flex w-full items-center justify-center space-x-2 rounded-lg bg-gray-100 px-6 py-3 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600'
        >
          <svg
            className='h-4 w-4'
            fill='none'
